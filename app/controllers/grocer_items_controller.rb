class GrocerItemsController < ApplicationController
  ...
  def new
    return redirect_back_data_error items_path unless params[:id].present?
    item = Item.find_by_id params[:id]
    return redirect_back_data_error new_grocer_item_path unless item.present?
    @id = item.id
    @name = item.name
  end
  ...
  def create
    ...
    return redirect_back_data_error new_grocer_item_path if grocer_item.invalid?
    grocer_item.save!
  ...
  def update
    return redirect_back_data_error items_path unless params[:id].present?
    grocer_item = GrocerItem.find_by_id params[:id]
    return redirect_back_data_error new_grocer_item_path unless grocer_item.present?
